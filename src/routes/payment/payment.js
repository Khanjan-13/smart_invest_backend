...
const { generateQR, initiatePayment, payViaMobile, bankCallback, checkStatus, checkBalance, transactionHistory, searchUser, walletHistory, getWalletBalance, getTransactionByTxnId } = require("../../controllers/payment/payment");
...
router.get("/transactions/:txn_id", getTransactionByTxnId);
